...
> 重点 gap:17 张弱覆盖中,4 张为本轮新发现关键词变体(#51 万通 PLC / #54 京东京造菊粉 / #55 京东京造番茄红素 / #60 哈佛特区),其余为已知规则需批量扩展 keywords。
...
## 03_名师教育申论保分班_第一年未录取第二年半价_教育.png

| 字段 | 值 |
|---|---|
| 文件名 | `03_名师教育申论保分班_第一年未录取第二年半价_教育.png` |
...
## 08_蜜蜜游俄罗斯椴树蜜电商页_8大优势_蜂蜜食品.png

| 字段 | 值 |
|---|---|
| 文件名 | `08_蜜蜜游俄罗斯椴树蜜电商页_8大优势_蜂蜜食品.png` |
| 桶分类 | food_function_claim × food_disease_target × internet_ad |
| 违规描述 | 普通食品(蜂蜜 / 蜜蜜游)在淘宝电商页宣称「8 大优势 — 改善营养 补充脑力 / 提高人体免疫力 / 增强食欲 / 消炎止痛」涉及疾病治疗 + 保健功能;「1000g 礼品盒装」「俄罗斯椴树蜜 天然野生椴树」属来源宣传 |
...
| 字段 | 值 |
|---|---|
| 文件名 | `09_榛蘑_可增强肌体免疫力益智_食用菌.png` |
| 桶分类 | food_function_claim × food_disease_target × internet_ad |
| 违规描述 | 普通食品(榛蘑 HAZEL MUSHROOMS)宣称「可增强肌体免疫力」「益智开心」「益气不饥」「延年轻身」涉及疾病治疗(免疫)+ 保健功能;「东北特有的山珍之一」属地理宣传 |
...
## 15_银泰集茶巷_品牌加冕财富启航_地产广告.jpeg

| 字段 | 值 |
|---|---|
| 文件名 | `15_银泰集茶巷_品牌加冕财富启航_地产广告.jpeg` |
| 桶分类 | education × absolute × data_citation |
...
| 字段 | 值 |
|---|---|
| 文件名 | `32_白桦树汁植物饮料_提高免疫力儿童和老人.png` |
...
| 字段 | 值 |
|---|---|
| 文件名 | `33_公考培训宋尚案老师_某省直机关在职领导_身份.png` |
| 桶分类 | `food_disease_target` × `food_function_claim` |
...
## 34_PICC松针油_降胆固醇辅助降压消炎恢复_保健.png

| 字段 | 值 |
|---|---|
| 文件名 | `34_PICC松针油_降胆固醇辅助降压消炎恢复_保健.png` |
...
| 字段 | 值 |
|---|---|
| 文件名 | `35_纳豆红曲地龙蛋白片_溶解血栓调节血糖_保健.png` |
...
## 36_水飞蓟籽油葛根枳椇子片_保肝降血脂_保健.png

| 字段 | 值 |
|---|---|
| 文件名 | `36_水飞蓟籽油葛根枳椇子片_保肝降血脂_保健.png` |
| 桶分类 | `food_function_claim` × `food_disease_target` |
...
| 字段 | 值 |
|---|---|
| 文件名 | `37_优普派阿苯达唑片_无效包退800万粉丝_兽药.png` |
| 桶分类 | `food_function_claim` × `internet_ad` |
...
| 字段 | 值 |
|---|---|
| 文件名 | `38_优普派非泼罗尼滴剂_药效持久800万粉丝_兽药.png` |
...
## 39_百自分高效氯氟氰菊酯_杀虫广谱害虫触杀_农药.png

| 字段 | 值 |
|---|---|
| 文件名 | `39_百自分高效氯氟氰菊酯_杀虫广谱害虫触杀_农药.png` |
| 桶分类 | `pesticide` × `internet_ad` |
| 违规描述 | 「百自分」2.5% 高效氯氟氰菊酯 水乳剂宣称「击倒迅速 安全高效」「杀虫广谱 害虫触杀」属农药功效断言 + 安全性断言;「正品保证 工厂直供」无农药广审文号 |
| 现行覆盖规则 | ad_signage_pesticide_art4_assertion, ad_signage_pesticide_art4_cure_rate |
| 覆盖状态 | 弱覆盖(关键词薄) |
| 建议动作 | 强化现规则 keywords(`ad_signage_pesticide_art4_assertion` 加「击倒迅速 / 安全高效 / 高效广谱」);`ad_signage_pesticide_art11_approval_no` 需新增此图作锚 |
| 关联法条 | 《农药广告审查发布规定》第四条第(一)项 + 第十一条 + 第十三条 / 《广告法》第二十一条 + 第五十八条 |

## 40_体重管理减肥产品_两月减重31斤_减肥承诺.png

| 字段 | 值 |
|---|---|
| 文件名 | `40_体重管理减肥产品_两月减重31斤_减肥承诺.png` |
| 桶分类 | `food_function_claim` × `internet_ad` |
...
| 字段 | 值 |
|---|---|
| 文件名 | `53_北大荒椴树雪蜜_提高人体免疫力_保健食品.png` |
| 桶分类 | `pestvet` × `fake_data` × `internet_ad` |
...
## 59_凯利集团汽车后服务市场_升涨机会钱景新区发展_6888元㎡23万起_地产.jpg

| 字段 | 值 |
|---|---|
| 文件名 | `59_凯利集团汽车后服务市场_升涨机会钱景新区发展_6888元㎡23万起_地产.jpg` |
| 桶分类 | `realestate` × `fake_data` |
| 违规描述 | 「逾期不候的升涨机会」「追赶全城渴望的钱景」「抓住新区发展走势 掌握未来经济繁荣所在」明示 / 暗示升值、投资回报承诺;「哈尔滨唯一汽车后服务专业市场」属绝对化用语;「86-248m² 金街商铺 6888 元/㎡」「40-57m² 精装公寓 23 万起」属价格承诺;无预售证号 / 无价格有效期 |
| 现行覆盖规则 | ad_signage_art26_re_prm, ad_signage_re_art7_license_no, ad_signage_art9_abs_top |
| 覆盖状态 | 已覆盖(升涨/钱景/新区 → art26;无预售证号 → re7;唯一 → art9) |
| 建议动作 | 强化现规则 keywords(`ad_signage_art26_re_prm` 加「升涨机会/钱景/新区发展走势/价值高地/未来经济繁荣」) |
| 关联法条 | 《广告法》第二十六条第(一)项 + 《房地产广告发布规定》第四条 / 第六条 + 《广告法》第九条第(三)项 + 第五十七条 / 第五十五条 |

## 60_哈佛特区_出门即校门接送不烦恼_60-139㎡学府世家_地产.jpg

| 字段 | 值 |
|---|---|
| 文件名 | `60_哈佛特区_出门即校门接送不烦恼_60-139㎡学府世家_地产.jpg` |
| 桶分类 | `realestate` × `absolute` |
| 违规描述 | 项目名「哈佛特区」+ 「出门即校门 接送不烦恼」「学府世家」涉嫌对规划 /建设中的文化教育设施作误导宣传(学区暗示);「领秀全城」属绝对化用语;面积 60‑139㎡ 表述模糊 |
| 现行覆盖规则 | ad_signage_art26_re_prm, ad_signage_art9_abs_top |
| 覆盖状态 | 已覆盖(领秀全城 → art9;学区暗示 → art26) |
| 建议动作 | 保持 |
| 关联法条 | 《广告法》第九条第(三)项 + 第二十六条第(四)项 + 第五十七条 |

## 61_三元教育公考_哈尔滨排名第一通过率75%_教育.jpg

| 字段 | 值 |
|---|---|
| 文件名 | `61_三元教育公考_哈尔滨排名第一通过率75%_教育.jpg` |
...
| ad_signage_art26_re_prm | n=3, Warning | 加「财富启航/财富实力/创富」(#03);加「升涨机会/钱景/新区发展走势/价值高地/未来经济繁荣」(#59) | #03, #59 |
| ad_signage_re_art26_planned_facility | n=5, Warning | 加「主题商街/国潮茶文化」(#03);加「智慧健康/体检区/健康体检区/锦绣全景/核心商圈」(#59) | #03, #59 |
...
| ad_signage_pesticide_art4_assertion | n=5, Violation | 加「击倒迅速/安全高效/高效广谱」 | #39 |
| ad_signage_pesticide_art11_approval_no | n=4, Warning | (待补;无广审文号应为 #39 锚) | #39 |
