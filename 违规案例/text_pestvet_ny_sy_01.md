...
预期命中规则:
  ...
  - id: ad_signage_medical_insurance_commitment
    severity: Warning
  备注_anchor_gate_v0_1_54: commit 2/3/4 起 pesticide/veterinary/medical_art8_commitment 加 categoryAnchors,本 fixture 文本(本社经营 农药 兽药 添加剂 + 无效退款 + 保险公司保险)无医疗锚点,medical_art8_commitment 不再触发;medical_insurance_commitment 因锚点含「保险」+「医疗」,仍命中(因 medical_insurance 锚点未变)。
