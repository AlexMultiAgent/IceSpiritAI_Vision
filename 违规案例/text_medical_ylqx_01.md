...
预期命中规则:
  ...
  - id: ad_signage_medical_art8_commitment
    severity: Warning
  备注_anchor_gate_v0_1_54: commit 2/3 起 pesticide + veterinary 规则加 categoryAnchors 后,本 fixture 文本(医疗器械)不含任何农药/兽药域锚点,pesticide_art10_commitment + veterinary_art8_commitment 不再触发。后续 commit 4 将对 medical_art8_commitment 同步加 anchor gate。
