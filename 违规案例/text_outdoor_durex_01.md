...
预期命中规则:
  - id: ad_signage_art9_abs_top
    severity: Warning
  备注_anchor_gate_v0_1_54_commit_5: commit 5 起 cosmetic_art9_abs_extended 加 categoryAnchors(化妆品/美容/护肤/肌肤),本 fixture 文本(公交车身杜蕾斯户外广告)无化妆品锚点,cosmetic_art9_abs_extended 不再触发。本 fixture 设计保留 art9_abs_top 跨桶单规则命中(户外广告绝对化用语通用情形)。
